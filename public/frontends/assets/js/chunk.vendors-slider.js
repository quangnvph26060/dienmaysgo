      ...
      !(function (n, s) {
          ...
          typeof (a = function () {
            ...
            return function e(a) {
              if (
                ...
                for (
                  var c = (l.isBorderBox = "border-box" == h.boxSizing), d = 0;
                  d < n;
                  d++
                ) {
                  var u = i[d],
                ...
                var w = t(h.height);
                return (
                  !1 !== w && (l.height = w + (S ? 0 : v + E)),
                  (l.innerWidth = l.width - (g + b)),
                  (l.innerHeight = l.height - (v + E)),
        ...
        (function (t, e) {
          ...
          (d = {
            ...
            (l =
              "function" == typeof (c = e)
                ? c.call(d.exports, i, d.exports, d)
                : c),
            (d.loaded = !0),
                ...
                (i.navCompanionSelect = function (t) {
                  ...
                  if (e) {
                    var i,
                      ...
                      o = s + e.length - 1,
                      r = Math.floor(
                        (o - (i = s)) * this.navCompanion.cellAlign + i
                      );
                    if (
