!(function (t) {
  ...
  function (t, e, n) {
    ...
    const i = document.body,
      ...
      r = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
        navigator.userAgent
      );
    let a = 0;
    function s() {
                        ...
                        t.each(s.axis.split(""), function (t, n) {
                          ...
                          if (c)
                            (p[r] = c[o] + (u ? 0 : a - h.offset()[o])),
                              s.margin &&
                                ((p[r] -=
                                  parseInt(f.css("margin" + i), 10) || 0),
                                (p[r] -=
                                  parseInt(f.css("border" + i + "Width"), 10) ||
                                  0)),
                              (p[r] += y[o] || 0),
                              s.over[o] &&
                                (p[r] +=
                          ...
                          s.limit &&
                            /^\d+$/.test(p[r]) &&
                            (p[r] = p[r] <= 0 ? 0 : Math.min(p[r], m)),
                            !t &&
                              s.axis.length > 1 &&
                              (a === p[r]
                                ? (p = {})
                                : l && (g(s.onAfterFirst), (p = {})));
                        }),
                          g(s.onAfter);
                      }
                      function g(e) {
                ...
                (t.Tween.propHooks.scrollLeft = t.Tween.propHooks.scrollTop =
                  {
                    ...
                    set: function (e) {
                      ...
                      n !== i &&
                        (t(e.elem)[e.prop](i), (e._last = this.get(e)));
                    },
                  }),
                e
              );
      ...
      (function () {
        ...
        function r(t) {
          (this.element = t),
            ...
            (e += 1),
            i.windowContext ||
              ((i.windowContext = !0), (i.windowContext = new r(window))),
        ...
        (r.prototype.add = function (t) {
          ...
          (r.prototype.createThrottledScrollHandler = function () {
            ...
            this.adapter.on("scroll.waypoints", function () {
              (t.didScroll && !i.isTouch) ||
                ((t.didScroll = !0), i.requestAnimationFrame(e));
            });
          }),
            ...
            (t = {
              ...
              for (var s in this.waypoints[r]) {
                ...
                h.element !== h.element.window &&
                  (y = h.adapter.offset()[a.offsetProp]),
                  "function" == typeof f
                    ? (f = f.apply(h))
                    : "string" == typeof f &&
                      ((f = parseFloat(f)),
                  ...
                  (d = !c && !u),
                  !g && c && u
                    ? (h.queueTrigger(a.backward), (o[h.group.id] = h.group))
                    : ((!g && d) || (g && a.oldScroll >= h.triggerPoint)) &&
                      (h.queueTrigger(a.forward), (o[h.group.id] = h.group));
              }
            }
            return (
                ...
                return (
                  this.each(function () {
                    if (
                      ...
                      "function" != typeof jQuery.data(this, "plugin_" + t)[r]
                    )
                      throw new Error(
                        "Method " + r + " does not exist on jQuery." + t
                      );
  ...
  function (t, e, n) {
    ...
    if (
      c &&
      (r.find(".header-wrapper").waypoint(
        function (t) {
      ...
      jQuery(window).on("scroll", () => {
        ...
        n >= o.outerHeight() &&
          (n <= e
            ? (o.addClass("stuck"),
              r.removeClass("sticky-hide-on-scroll--active"))
            : (o.removeClass("stuck"),
  ...
  function (t, e, n) {
        ...
        (function (t) {
          ...
          if (!(l.top > o || l.top + r.offsetHeight < 0))
            switch (n) {
              case "backgroundImage":
                (m = l.top * i),
                  (e.style.backgroundPosition = i
                    ? "50% ".concat(m.toFixed(0), "px")
                    : null),
              ...
              case "backgroundElement":
                (m = p * i - a / 2),
                  (e.style.transform = i
                    ? "translate3d(0, ".concat(m.toFixed(2), "px, 0)")
                    : null),
    ...
    window.addEventListener("scroll", a, { passive: !0 }),
      ...
      new MutationObserver(a).observe(document.body, { childList: !0 }),
      window.jQuery &&
    ...
    jQuery.fn.flickity || (jQuery.fn.flickity = o),
      (jQuery.fn.lazyFlickity = function (t) {
        ...
        return this.each((n, i) => {
          "string" == typeof t
            ? jQuery.fn.flickity && jQuery(i).flickity(t)
            : e.observe(i);
        });
      });
  },
      ...
      return this.each((e, i) => {
        ...
        "string" == typeof t
          ? jQuery.fn.tooltipster &&
            o.hasClass("tooltipstered") &&
            o.tooltipster(t)
          : o.one("mouseenter", (e) => {
              !(function (t, e) {
                (jQuery.fn.tooltipster
                  ? Promise.resolve()
                  : n.e(3).then(n.t.bind(null, 55, 7))
                ).then(() => {
        ...
        jQuery("select.resizeselect").resizeselect(),
          ...
          jQuery.fn.packery &&
            (jQuery("[data-packery-options], .has-packery", t).each(
              function () {
                let t = jQuery(this);
                t.packery({ originLeft: !flatsomeVars.rtl }),
                  setTimeout(function () {
    ...
    Flatsome.behavior("count-up", {
      attach(t) {
        jQuery("span.count-up", t).each(function (t, e) {
          ...
          i.waypoint({
            handler(t) {
              jQuery(this.element).hasClass("active") ||
                n
                  .e(0)
                  .then(n.bind(null, 56))
                  .then((t) => {
    ...
    (function (t) {
          ...
          (function (e) {
            ...
            if (l && !s) {
              ...
              f > y && f < p && (g = (f + y) / 3),
                y < 0 && (g = -y),
                g && c
                  ? n.css("margin-right", -g)
                  : g && n.css("margin-left", -g),
            ...
            if (a) {
              ...
              n.css({
                width: s ? i - o.width() : i,
                ...(!c && { left: t.left - e.left + 15 }),
                ...(c && { right: 15 - (t.right - e.right) }),
              });
            }
            if (r) {
              n.css({ inset: 0 });
              ...
              n.css({
                ...
                ...(!c && { left: e.left - i.left }),
                ...(c && { right: -(e.right - i.right) }),
              });
            }
            if ((a || r) && !s) {
              let t = null;
      ...
      Flatsome.behavior("dropdown", {
        attach(t) {
          ...
          let u = !1,
            d = null;
          jQuery(".header-nav > li > a, .top-bar-nav > li > a", t).on(
            "focus",
            () => {
              i(a);
            }
    ...
    Flatsome.behavior("slider", {
      attach(t) {
        ...
        (e = jQuery(t).data("flickityOptions")
          ? jQuery(t)
          : jQuery("[data-flickity-options]", t)).length &&
          e.each((t, e) => {
            var n = jQuery(e),
              o = n.closest(".slider-wrapper"),
              r = n.data("flickity-options");
            if (
              ("undefined" != typeof UxBuilder && (r.draggable = !1),
              !0 === r.watchCSS)
            )
              return;
            let a = !1,
    ...
    function n(t, e, n) {
      e.each((e, n) => {
        jQuery(n).toggleClass("active", e === t),
          jQuery(n)
            .find("> a")
            .attr("aria-selected", e === t ? "true" : "false")
            .attr("tabindex", e === t ? null : "-1");
      }),
        n.each((e, n) => jQuery(n).toggleClass("active", e === t)),
        jQuery.fn.packery &&
          jQuery("[data-packery-options]", n[t]).packery("layout");
    }
    ...
    Flatsome.behavior("toggle", {
      attach(t) {
        ...
        jQuery(
          ...
          const t = jQuery(this).parents(".nav-slide").length
            ? "right"
            : "down";
          jQuery(this)
            .parent()
            ...
            jQuery(this).before(
              '<button class="toggle" aria-label="'
                .concat(
                  window.flatsomeVars.i18n.toggleButton,
                  '"><i class="icon-angle-'
                )
                .concat(t, '"></i></button>')
            );
          ...
          jQuery(
            ...
            l.off("click").on("click", (t) => {
              ...
              a.attr("aria-expanded", "true"),
                ...
                r.css(
                  "transform",
                  "translateX(".concat(d ? "" : "-").concat(100 * u, "%)")
                ),
              ...
              h.find(".toggle").on("click", () => {
                r.css(
                  "transform",
                  "translateX(".concat(d ? "" : "-").concat(100 * (u - 1), "%)")
                ),
                  n(o),
                  (f = setTimeout(() => {
  ...
  function (t, e) {
    Flatsome.behavior("scroll-to", {
      attach() {
        ...
        if (
          (e.length && (e.children().lazyTooltipster("destroy"), e.remove()),
      ...
      attach(t) {
        const e = Object(i.a)((t) => {
          t.intersectionRatio > 0 &&
            (e.unobserve(t.target), jQuery(t.target).addClass("bg-loaded"));
        });
      ...
      attach(t) {
        jQuery(".sticky-section", t).each(function (t, e) {
          ...
          n.waypoint(
            function (t) {
              "down" === t &&
                (n.addClass("is-sticky-section"),
                n.after('<div class="sticky-section-helper"></div>')),
                "up" === t &&
                  (n.removeClass("is-sticky-section"),
        ...
        jQuery(".is-sticky-column", t).each((t, o) => {
          n.e(2)
            ...
            .then(() => {
              ...
              null == t ||
                t.observe(jQuery(".is-sticky-column__inner", o).get(0)),
                jQuery(document).on(
                  "updated_checkout flatsome-sticky-sidebar-update-sticky flatsome-infiniteScroll-append",
                  function () {
                    jQuery(o).stickySidebar("updateSticky");
                  }
                );
  ...
  function (t, e, n) {
    ...
    n(1).a &&
      ...
      console.groupCollapsed(
        "%cFlatsome%c: ".concat("Prefer reduced motion is active on your OS"),
