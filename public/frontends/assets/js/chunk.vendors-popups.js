              ...
              (s.prototype = {
                ...
                updateItemHTML: function () {
                  ...
                  if (
                    ...
                    u("FirstMarkupParse", a), (t.currTemplate[i] = !a || e(a));
                  }
                  o &&
                    o !== n.type &&
                  ...
                  proto: {
                      ...
                      if (n.enabled && t.supportsTransition) {
                        ...
                        p("BuildControls" + i, function () {
                          ...
                          p("BeforeClose" + i, function () {
                            if (t._allowZoom()) {
                              if (
                                (clearTimeout(o), (t.st.removalDelay = r), !e)
                              ) {
                    ...
                    _getOffset: function (n) {
                      ...
                      var s = {
                        width: i.width(),
                        height:
                          (l ? i.innerHeight() : i[0].offsetHeight) - r - a,
                      };
                      return (
                        void 0 === x &&
                          (x =
