...
<body>
    <div class="maintenance">
        <div class="maintenance_contain">
            ...
            <span class="pp-infobox-title-prefix">HỆ THỐNG ĐANG BẢO TRÌ</span>
            <div class="pp-infobox-title-wrapper">
                <h3 class="pp-infobox-title">Xin lỗi vì sự bất tiện này!</h3>
            </div>
            <div class="pp-infobox-description">
                <p>Chúng tôi đang nâng cấp hệ thống để phục vụ bạn tốt hơn.<br>
                    Vui lòng quay lại sau. Cảm ơn bạn đã kiên nhẫn chờ đợi!</p>
            </div>
        </div>
    </div>
