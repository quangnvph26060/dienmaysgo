...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ isset($home) ? route('admin.home.update', $home->id) : route('admin.home.store') }}"
            ...
            <div class="row ">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="content" name="content"
                            ...
                            placeholder="Enter content">{{ old('content', $home->content ?? '') }}</textarea>
                        @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="title_seo" name="title_seo"
                            ...
                            value="{{ old('title_seo', $home->title_seo ?? '') }}">
                        @error('title_seo')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description_seo" name="description_seo"
                            ...
                            placeholder="Enter SEO description">{{ old('description_seo', $home->description_seo ?? '') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="keyword_seo" name="keyword_seo"
                            ...
                            placeholder="Enter SEO keywords" value="{{ old('keyword_seo', $home->keyword_seo ?? '') }}">
                        @error('keyword_seo')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-success">{{ isset($home) ? 'Cập nhật' : 'Lưu' }}</button>
                </div>
        </form>
