            ...
            <div class="large-9 col">
                <div id="row-1845589467" class="row large-columns-3 medium-columns- small-columns-1 row-masonry"
                    ...
                    @forelse ($news as $new)
                        <div class="col post-item">
                            <div class="col-inner">
                                <a href="{{ route('news.list', ['slug' => $new->slug]) }}" class="plain">
                ...
                @if ($news->hasPages())
                    <ul class="page-numbers nav-pagination links text-center">
                        @if ($news->onFirstPage())
                            <li>
                                <span class="page-number disabled" aria-disabled="true"><i
                                    ...
                                    @if ($page == $news->currentPage())
                                        <li>
                                            <span aria-current="page"
                                                class="page-number current">{{ $page }}</span>
                                        </li>
                                    @else
                                        <li>
                        ...
                        @if ($news->hasMorePages())
                            <li>
                                <a class="page-number next" href="{{ $news->nextPageUrl() }}"><i
