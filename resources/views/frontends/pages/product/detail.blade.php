...
@section('content')
                                    ...
                                    <div class="product-images relative mb-half has-hover woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images"
                                        ...
                                        <figure
                                            ...
                                            <div class="woocommerce-product-gallery__image slide first">
                                                <a href="https://dienmaysgo.com/wp-content/uploads/2023/01/may-phat-dien-elemax-sv2800-1.jpg"
                                                    data-lightbox="product-gallery"
                                                    data-title="Máy phát điện Elemax SV2800">
                                                    <img id="main-image" width="458" height="458"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-phat-dien-elemax-sv2800-1.jpg"
                                                        alt="" title="may-phat-dien-elemax-sv2800-1"
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-phat-dien-elemax-sv2800-1-100x100.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-phat-dien-elemax-sv2800-1.jpg"
                                                        alt="Thumbnail 1" />
                                                </div>
                                                <!-- Thumbnail 2 -->
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/Untitled-1-11Untitled-1-11.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/01/Untitled-1-11Untitled-1-11.jpg"
                                                        alt="Thumbnail 2" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-nen-khi-truc-vit-puma-sp50-50hp-300x300.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-nen-khi-truc-vit-puma-sp50-50hp-300x300.jpg"
                                                        alt="Thumbnail 2" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/05/May-nen-khi-truc-vit-Denyo-DIS-275SS2.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/05/May-nen-khi-truc-vit-Denyo-DIS-275SS2.jpg"
                                                        alt="Thumbnail 2" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-no-dong-co-dau-10-3hp-koop-kd192fe-co-de.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-no-dong-co-dau-10-3hp-koop-kd192fe-co-de.jpg"
                                                        alt="Thumbnail 2" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img class="gallery-thumb"
                                                        src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-no-dong-co-xang-9hp-robin-rbn-ex27.jpg"
                                                        data-large-src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-no-dong-co-xang-9hp-robin-rbn-ex27.jpg"
                                                        alt="Thumbnail 2" />
                                                </div>
    ...
    margin: 20px 0;">
                                    ...
                                    @if ($product->price)
                                        ...
                                        <form class="cart"
                                            action="https://dienmaysgo.com/may-phat-dien-chay-xang-elemax-sv2800/"
                                            method="post" enctype="multipart/form-data">
                                            <div class="sticky-add-to-cart-wrapper">
                                                <div class="sticky-add-to-cart">
                                                    <div class="sticky-add-to-cart__product">
                                                        <img src="https://dienmaysgo.com/wp-content/uploads/2023/01/may-phat-dien-elemax-sv2800-1-100x100.jpg"
                                                            alt="" class="sticky-add-to-cart-img" />
                                                        <div class="product-title-small hide-for-small">
                                                            <strong>Máy Phát Điện Chạy Xăng Elemax SV2800</strong>
                                                        </div>
                                                        <div class="price-wrapper">
                                                            <p class="price product-page-price">
                                                    ...
                                                    <div class="quantity buttons_added form-flat">
                                                        ...
                                                        <label class="screen-reader-text" for="quantity_674f195d66f6f">Máy
                                                            Phát Điện Chạy Xăng Elemax SV2800
                                                            quantity</label>
                                                        ...
                                                        <div id="respond" class="comment-respond">
                                                            ...
                                                            <form action="https://dienmaysgo.com/wp-comments-post.php"
                                                                ...
                                                                <p style="display: none !important"
                                                                    ...
                                                                    </label><input type="hidden" id="ak_js_1"
                                                                        name="ak_js" value="115" />
                                                                    <script>
                                                                        document
